...
#	nfa=map(float,nfa)
	...
	width = 0.3
	ax1.bar(x+width, opennf,width, label="Old seastar",  hatch="/",color='r')
	ax1.bar(x+2*width,nfa,width, label="New seaster", hatch="\\",color='g')
        ax1.bar(x+3*width,base_line,width,label="Base line",hatch="",color='b')
